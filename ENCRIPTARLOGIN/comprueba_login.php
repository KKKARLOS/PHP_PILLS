...
try{
	...
	while($registro=$resultado->fetch(PDO::FETCH_ASSOC)){			
		...
		//$valor = password_verify($password, $registro['PASSWORD'] );
		//echo "Usuario: " . $registro['USUARIO'] . " Contraseña: " . $registro['PASSWORD'] . "  Password introducido: $password  Valor: $valor <br>";		
